...
namespace NumberGuessingGame
{
    ...
    class GameManager
    {
        ...
        {
            Console.WriteLine("Please enter a difficulty between easy (e), medium (m), or hard (h): ");
            ...
            while (!isValidInput)
            {
                ...
                switch (difficulty)
                {
                    ...
                    case "h":
                        ...
                        break;
                    default:
                        Console.WriteLine("Invalid input. Please enter a difficulty between easy (e), medium (m), and hard (h): ");
                        break;
                }
            }
        }
        ...
        private void DisplayGameResults()
        {
            ...
            if (gameWon)
            {
                ...
                {
                    case DifficultyLevel.Easy:
                        currentPlayer.BestScoreEasy = (currentAttempts < currentPlayer.BestScoreEasy || currentPlayer.BestScoreEasy == 0) ? currentAttempts : currentPlayer.BestScoreEasy;
                        break;
                    case DifficultyLevel.Medium:
                        currentPlayer.BestScoreMedium = (currentAttempts < currentPlayer.BestScoreMedium || currentPlayer.BestScoreMedium == 0) ? currentAttempts : currentPlayer.BestScoreMedium;
                        break;
                    case DifficultyLevel.Hard:
                        currentPlayer.BestScoreHard = (currentAttempts < currentPlayer.BestScoreHard || currentPlayer.BestScoreHard == 0) ? currentAttempts : currentPlayer.BestScoreHard;
                        break;
                }
            }
            else
        ...
        private void DisplayFinalStats()
        {
            ...
            Console.WriteLine($"Best Score (Easy): {currentPlayer.BestScoreEasy}");
            Console.WriteLine($"Best Score (Medium): {currentPlayer.BestScoreMedium}");
            Console.WriteLine($"Best Score (Hard): {currentPlayer.BestScoreHard}");
